...
///////////////////////////////////////////////////////
	...
	//(BE AWARE THAT NOISE AND SCINTILLATION SCALE WITH NVG GAIN)
		...
		#define gen_1_nvg_noise_factor float (0.3)				// Default 0.15 - How much noise to add to NVG image. (0 = none, 0.5 = insane)
	...
	// NVG COLOR OPTIONS:
		...
		#define gen_2_saturation_color float3 (0.7,0.9,1)	// Gen1 NVG color - it defines the max amount of color from 0 to 1 using (Red,Green,Blue)
		#define gen_3_saturation_color float3 (0.7,0.9,1)	// Gen1 NVG color - it defines the max amount of color from 0 to 1 using (Red,Green,Blue)
