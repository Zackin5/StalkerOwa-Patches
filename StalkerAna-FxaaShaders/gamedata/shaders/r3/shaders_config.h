...
// Gasmask vignette settings
#define GAS_Vignette true
#define GAS_Vignette_Ratio 1.0
#define GAS_Vignette_Radius 0.85
#define GAS_Vignette_Slope 4.0
#define GAS_Vignette_Amount -1.0
